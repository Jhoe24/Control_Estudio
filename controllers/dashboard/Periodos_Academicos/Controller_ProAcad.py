...
class PeriodoAcademicoController:
    ...
    def obtener_datos_vista(self, vista_formulario):
        ...
        datos_periodo = {
            ...
            "fecha_inicio_inscripcion": vista_formulario.fecha_inicio_inscripcion.get_date(),   
            "fecha_fin_inscripcion": vista_formulario.fecha_fin_inscripcion.get_date(),
            "fecha_inicio_clases": vista_formulario.fecha_inicio_clases.get_date(),
            "fecha_fin_clases": vista_formulario.fecha_fin_clases.get_date(),
            "fecha_inicio_evaluaciones": vista_formulario.fecha_inicio_evaluaciones.get_date(),
            "fecha_fin_evaluaciones": vista_formulario.fecha_fin_evaluaciones.get_date(),
