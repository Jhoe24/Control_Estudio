...
class UnidadCurricular(SectionFrameBase):
    def __init__(self, master, vcmd_num):
        ...
        self._crear_fila_widgets([
            ("Código:", crear_entry, {"width":300,"placeholder_text":"Ingrese código"}, 1, self.scroll, 'codigo_entry',True),
            ("Nombre:", crear_entry, {"width":300,"placeholder_text":"Ingrese el nombre de la U.C"}, 1, self.scroll, 'nombre_entry',True),
            ("Nombre corto:", crear_entry, {"width":300,"placeholder_text":"Ingrese el nombre corto"}, 1, self.scroll, 'nombre_corto_entry',True),
            ("Área:", crear_entry, {"width":300,"placeholder_text":"Ingrese área"}, 1, self.scroll, 'area_entry',True),
            ("Sub-area:", crear_entry, {"width":300,"placeholder_text":"Ingrese Sub-area"}, 1, self.scroll, 'subarea_entry',True),
            ("Eje Formativo:", crear_entry, {"width":300,"placeholder_text":"Ingrese el eje formativo"}, 1, self.scroll, 'eje_formativo_entry',True),
        ])
