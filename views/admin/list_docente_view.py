...
from .docente_form_view import FormularioDocenteView
...
class ListDocenteView(ctk.CTkScrollableFrame):
    def __init__(self, master, controlador):
        ...
        self.filas_datos = []
        self.cantidad_docente = self.controlador.master_controlador.docente.modelo_docente.obtener_cantidad_docente()
        self.pagina_actual = 1
        self.primer_id_table = self.controlador.master_controlador.docente.modelo_docente.obtener_primer_id()
        self.docente = self.controlador.master_controlador.docente.obtener_lista_docentes(0)
        ...
        try:
            ...
            self.vcmd_num_val = toplevel.register(self.controlador.master_controlador.docente._solo_numeros)
            self.vcmd_fecha_val = toplevel.register(self.controlador.master_controlador.docente._numeros_y_barras)
            self.vcmd_decimal_val = toplevel.register(self.controlador.master_controlador.docente._solo_decimal)
        except Exception: # Fallback si no es un toplevel (ej. si el master es el root)
            self.vcmd_num_val = master.register(self.controlador.master_controlador.docente._solo_numeros)
            self.vcmd_fecha_val = master.register(self.controlador.master_controlador.docente._numeros_y_barras)
            self.vcmd_decimal_val = master.register(self.controlador.master_controlador.docente._solo_decimal)
    ...
    def cargar_docentes_en_segundo_plano(self, offset):
        ...
        def tarea():
            ...
            self.docente = self.controlador.master_controlador.docente.obtener_lista_docentes(offset)
