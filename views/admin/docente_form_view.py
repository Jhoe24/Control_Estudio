...
class FormularioDocenteView(ctk.CTkScrollableFrame):
    ...
    def limpiar_formulario_completo(self):
        ...
        """
        self.controlador.master_controlador.docente.limpiar_formulario_completo(self)
    ...
    def procesar_formulario(self):
        resultado = self.controlador.master_controlador.docente.obtener_todos_los_datos(self)
        exito = self.controlador.master_controlador.docente.registrar_docente(resultado, self)
        if exito:
            self.controlador.master_controlador.docente.limpiar_formulario_completo(self)
