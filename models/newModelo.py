...
class SistemaAcademicoDB:
    ...
    def crear_tablas_academicas(self):
        ...
        CREATE TABLE IF NOT EXISTS docentes (
            ...
            especialidad TEXT,
            fecha_ingreso DATE,
            tipo_contrato TEXT CHECK (tipo_contrato IN ('Tiempo completo', 'Medio tiempo', 'Por horas', 'Contratado')),
            categoria TEXT,
            auxiliar BOOLEAN DEFAULT 0,
            dedicacion TEXT CHECK (dedicacion IN ('Exclusiva', 'Tiempo completo', 'Medio tiempo', 'Tiempo convencional')),
